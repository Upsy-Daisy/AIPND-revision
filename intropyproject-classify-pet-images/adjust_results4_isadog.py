...
def adjust_results4_isadog(results_dic, dogfile):
    ...
    with open(dogfile, "r") as infile:
        # Reads in dogname from first line in file
        ...
        while line != "":
            ...
            if line not in dognames_dic:
                ...
                print("** Warning: Duplicate dog name", line, "exists in file", 
                      dogfile)
    ...
    # two items to end of value(List) for each key(filename) in results_dic
    # where Index 3 = whether(1) or not(0) Pet Image Label is a dog AND 
    # Index 4 = whether(1) or not(0) Classifier Label is a dog
